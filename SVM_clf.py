...
def get_X_and_y(pl_indx, pl_list):
	...
	save_npy(X_MIR, X_MIR_val, y_MIR, y_MIR_val,'MIR','SVM',pl_indx,pl_list)
	save_npy(X_SPO, X_SPO_val, y_SPO, y_SPO_val,'SPO','SVM',pl_indx,pl_list)
	save_npy(X_LYR, X_LYR_val, y_LYR, y_LYR_val,'LYR','SVM',pl_indx,pl_list)
	save_npy(X_ALL, X_ALL_val, y_ALL, y_ALL_val,'ALL','SVM',pl_indx,pl_list)
	...
	## SVM - MIR 
	param_file = param_folder+'/MIR/'+'SVM.pkl'
	if path.exists(param_file):
		print(' LOADING PARAMETERS:')
		print('	SVM - Parameter Models')
		print('	MIR:')
		model_parameters_SVM_MIR = open_parameters('SVM','MIR',pl_indx)#,y_MIR,num_folds)
	else:
		print(' COMPUTING PARAMETERS:')
		print('	SVM - Parameter Models')
		print('	MIR:')
		model_parameters_SVM_MIR = perform_grid_search('SVM',X_MIR,y_MIR,num_folds)
		save_parameters(param_folder,model_parameters_SVM_MIR,'SVM','MIR',pl_indx)	

	## SVM - SPO
	param_file = param_folder+'/SPO/'+'SVM.pkl'
	if path.exists(param_file):
		print(' LOADING PARAMETERS:')
		print('	SVM - Parameter Models')
		print('	SPO:')
		model_parameters_SVM_SPO = open_parameters('SVM','SPO',pl_indx)#X_SPO,y_SPO,num_folds)
	else:
		print(' COMPUTING PARAMETERS:')
		print('	SVM - Parameter Models')
		print('	SPO:')
		model_parameters_SVM_SPO = perform_grid_search('SVM',X_SPO,y_SPO,num_folds)
		save_parameters(param_folder,model_parameters_SVM_SPO,'SVM','SPO',pl_indx)		

	## SVM - LYR
	param_file = param_folder+'/LYR/'+'SVM.pkl'
	if path.exists(param_file):
		print(' LOADING PARAMETERS:')
		print('	SVM - Parameter Models')
		print('	LYR:')
		model_parameters_SVM_LYR = open_parameters('SVM','LYR',pl_indx)#X_LYR,y_LYR,num_folds)
	else:
		print(' COMPUTING PARAMETERS:')
		print('	SVM - Parameter Models')
		print('	LYR:')
		model_parameters_SVM_LYR = perform_grid_search('SVM',X_LYR,y_LYR,num_folds)
		save_parameters(param_folder,model_parameters_SVM_LYR,'SVM','LYR',pl_indx)			

	## SVM - ALL 
	param_file = param_folder+'/ALL/'+'SVM.pkl'
	if path.exists(param_file):
		print(' LOADING PARAMETERS:')
		print('	SVM - Parameter Models')
		print('	ALL:')
		model_parameters_SVM_ALL = open_parameters('SVM','ALL',pl_indx)#X_ALL,y_ALL,num_folds)
	else:
		print(' COMPUTING PARAMETERS:')
		print('	SVM - Parameter Models')
		print('	ALL:')
		model_parameters_SVM_ALL = perform_grid_search('SVM',X_ALL,y_ALL,num_folds)
		save_parameters(param_folder,model_parameters_SVM_ALL,'SVM','ALL',pl_indx)			
	'''
	else:
		print(' # # # # # # ')
		print('- Loading all parameters saved:')
		model_parameters_SVM_MIR = open_parameters('SVM','MIR',pl_indx)
		model_parameters_SVM_SPO = open_parameters('SVM','SPO',pl_indx)
		model_parameters_SVM_LYR = open_parameters('SVM','LYR',pl_indx)
		model_parameters_SVM_ALL = open_parameters('SVM','ALL',pl_indx)
	'''
	...
	print_save(pl_indx,pl_list,'SPOTIFY DATASET',' SVM ',y_true, y_pred, X_SPO_val, y_SPO_val,model_parameters_SVM_SPO)

	## 		LYRICS DATASET 
	## 		SVM
	y_true, y_pred = y_LYR_val, SVM_clf_LYR.predict(X_LYR_val)
	print_save(pl_indx,pl_list,'LYRICS DATASET',' SVM ',y_true, y_pred, X_LYR_val, y_LYR_val,model_parameters_SVM_LYR)

	## 		MIR DATASET
	## 		SVM
	y_true, y_pred = y_MIR_val, SVM_clf_MIR.predict(X_MIR_val)
	print_save(pl_indx,pl_list,'  MIR  DATASET',' SVM ',y_true, y_pred, X_MIR_val, y_MIR_val,model_parameters_SVM_MIR)

	## 		ALL DATASET 
	##		SVM
	y_true, y_pred = y_ALL_val, SVM_clf_ALL.predict(X_ALL_val)
	print_save(pl_indx,pl_list,'  ALL  DATASET',' SVM ',y_true, y_pred, X_ALL_val, y_ALL_val,model_parameters_SVM_ALL)
