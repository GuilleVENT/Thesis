...
def get_X_and_y(pl_list):
	...
	print_save(pl_list,'SPOTIFY DATASET',' SVM ',y_true, y_pred, X_SPO_val, y_SPO_val,model_parameters_SVM_SPO)


	## 		SPOTIFY DATASET 
	## 		RF
	y_true, y_pred = y_SPO_val, RF_clf_SPO.predict(X_SPO_val)
	print_save(pl_list,'SPOTIFY DATASET',' RF ',y_true, y_pred, X_SPO_val, y_SPO_val,model_parameters_RF_SPO)

	## 		SPOTIFY DATASET 
	## 		kNN
	y_true, y_pred = y_SPO_val, kNN_clf_SPO.predict(X_SPO_val)
	print_save(pl_list,'SPOTIFY DATASET',' kNN ',y_true, y_pred, X_SPO_val, y_SPO_val,model_parameters_kNN_SPO)
	...
	print_save(pl_list,'LYRICS DATASET',' SVM ',y_true, y_pred, X_LYR_val, y_LYR_val,model_parameters_SVM_LYR)

	## 		LYRICS DATASET 
	## 		RF
	y_true, y_pred = y_LYR_val, RF_clf_LYR.predict(X_LYR_val)
	print_save(pl_list,'LYRICS DATASET',' RF ',y_true, y_pred, X_LYR_val, y_LYR_val,model_parameters_RF_LYR)

	## 		LYRICS DATASET 
	## 		kNN
	y_true, y_pred = y_LYR_val, kNN_clf_LYR.predict(X_LYR_val)
	print_save(pl_list,'LYRICS DATASET',' kNN ',y_true, y_pred, X_LYR_val, y_LYR_val,model_parameters_kNN_LYR)
	...
	print_save(pl_list,'  MIR  DATASET',' SVM ',y_true, y_pred, X_MIR_val, y_MIR_val,model_parameters_SVM_MIR)
...
def print_save(pl_list,data_set, clf, y_true, y_pred, X_val, y_val, params):
